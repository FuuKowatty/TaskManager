...
export default function LoginPage() {
  ...
  return (
    <div className="flex h-screen w-screen items-center justify-center bg-lightGray dark:bg-darkGray">
      <div className="focus-within: rounded-md bg-white px-16 pb-8 pt-24 text-darkGray shadow-md shadow-gray-300 dark:bg-graY dark:shadow-gray-600">
