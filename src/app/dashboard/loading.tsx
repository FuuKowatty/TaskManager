export default function DashboardLoading() {
  return (
    <main className="flex w-full animate-pulse  flex-col justify-items-center gap-5 text-black lg:grid lg:grid-cols-1FR340PX lg:grid-rows-6 lg:gap-x-4 lg:overflow-hidden">
      <div
        role="status"
